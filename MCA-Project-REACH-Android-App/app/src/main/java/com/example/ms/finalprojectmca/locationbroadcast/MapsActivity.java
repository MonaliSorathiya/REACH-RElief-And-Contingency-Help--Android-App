package com.example.ms.finalprojectmca.locationbroadcast;
...
import com.example.ms.finalprojectmca.R;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.locationvroadcast_activity_maps);
    ...
    private String getUrl(double latitude, double longitude, String nearbyPlace) {
        ...
        googlePlacesUrl.append("&key=" + "AIzaSyDYOEkysIWI2TPgcBhBMknChQtUurH9Pmc");
